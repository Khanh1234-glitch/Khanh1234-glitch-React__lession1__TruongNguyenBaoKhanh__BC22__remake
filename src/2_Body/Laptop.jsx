...
export default function Laptop() {
    const styleObject = {maxWidth:"100%", height: "250px"}
  return (
    <div>
    <section id="laptop" className="container-fluid pt-5 pb-5 bg-light text-dark">
      ...
      <div className="row">
        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
          <div className="container">
            <div className="card bg-light" >
              <img className="card-img-top" src="./img/lt_macbook.png" alt="Card image" style={styleObject} />
        ...
        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
          <div className="container">
            <div className="card bg-light" >
              <img className="card-img-top" src="./img/lt_rog.png" alt="Card image" style={styleObject}/>
              <div className="card-body text-center">
        ...
        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
          <div className="container">
            <div className="card bg-light" >
              <img className="card-img-top" src="./img/lt_hp.png" alt="Card image" style={styleObject}/>
              <div className="card-body text-center">
        ...
        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
          <div className="container">
            <div className="card bg-light" >
              <img className="card-img-top" src="./img/lt_lenovo.png" alt="Card image"style={styleObject}/>
              <div className="card-body text-center">
